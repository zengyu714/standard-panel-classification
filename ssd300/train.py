...
parser.add_argument('--resume', default='ssd300/weights/ssd300_0712_100000.pth', type=str,
...
def train():
    ...
    dataset = SSDDataset(args.voc_root, train_sets, Augmentation(ssd_dim, means), AnnotationTransform())
    ...
    data_loader = data.DataLoader(dataset, batch_size, num_workers=args.num_workers,
                                  shuffle=True, collate_fn=ssd_collate, pin_memory=True)
    for iteration in range(args.start_iter, max_iter):
        ...
        if iteration % 10 == 0:
            ...
            if args.visdom and args.send_images_to_visdom:
                ...
                viz.image(images.data[random_batch_index].cpu().numpy(), win='fixed')
        if args.visdom:
            viz.line(
        ...
        if iteration % 5000 == 0:
            ...
            torch.save(ssd_net.state_dict(), 'ssd300/weights/ssd300_0712_' + repr(iteration) + '.pth')
