...
set_type = 'val'
eval_model_step = args.trained_model.split('_')[-1][:-4]
...
def test_net(save_folder, net, cuda, dataset, transform, top_k,
    ...
    output_dir = get_output_dir('ssd300/eval/ssd300_{}'.format(eval_model_step), set_type)
...
if __name__ == '__main__':
    ...
    # load data
    dataset = SSDDataset(args.voc_root, [('2007', set_type)], BaseTransform(300, dataset_mean), AnnotationTransform())
    if args.cuda:
        net = net.cuda()
